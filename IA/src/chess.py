    ...
    def _calculate_possible_moves(self, piece_idx, *args, **kwargs):
        ...
        for possible_move in possible_moves:
            try:
                ...
                print(possible_move)
    def _posible_moves_calculate_(self, *args, **kwargs):
        #This will show possible moves
        possible_moves = self._calculate_possible_moves(move)

        for move in possible_moves:
            surface.blit(player_1_piece, 'coords')
            ...
            for event in ev:
                ...
                if (event.__dict__.get('button', False) == PLAYER_1
                    ...
                    if piece_in_collision is not False:
                        ...
                        self._posible_moves_calculate_(self.move)
            pygame.display.flip()
